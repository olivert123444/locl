                ...
                {listings.length === 0 ? (
                  ...
                  <View style={styles.listingsContainer}>
                    {listings.map((listing) => (
                      ...
                      >
                        <Image 
                          source={listing.main_image_url ? { uri: listing.main_image_url } : require('@/assets/images/placeholder.png')} 
                ...
                {savedItems.length === 0 ? (
                  ...
                  <View style={styles.listingsContainer}>
                    {savedItems.map((item) => (
                      ...
                      >
                        <Image 
                          source={item.main_image_url ? { uri: item.main_image_url } : require('@/assets/images/placeholder.png')} 
                          style={styles.listingImage} 
                        />
                        <View style={styles.listingDetails}>
